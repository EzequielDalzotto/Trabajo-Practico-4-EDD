from src.utilities.data_structures import BinaryTreeNode
from src.utilities.linked_binary_tree_ext import LinkedBinaryTreeExt
...
print(arbol.hermanos(nodo_b,nodo_f)) #Funciona

print(arbol.hojas()) #Funciona

print(arbol.internos()) #Funciona

print(arbol.profundidad(nodo_m)) #Funciona

print(arbol.altura(nodo_a)) #Funciona
